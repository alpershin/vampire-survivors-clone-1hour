...
## Сколько ушло на разработку
- Минут 5-10 на разработку плана в Gemini
- Чуть больше часа на саму разработку в Unity 

## Как использовался ИИ
- Был составлен поэтапный план разработки прототипа по документу в Gemini 3 Pro
- Скормил план в Copilot Pro
- Вносил точечные правки в неработающие механики
- Использовал Legacy инпут систему, чтобы не настраивать управление в файле новой инпут системы
- Настроил Canvas и компоненты по инструкции, которую мне выдал ИИ
